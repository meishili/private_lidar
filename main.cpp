...
int main(int argc, char *argv[])
{
    ...
    std::unique_ptr<double[]> distance = std::make_unique<double[]>(size);
    std::unique_ptr<double[]> p532 = std::make_unique<double[]>(size);
    std::unique_ptr<double[]> p607 = std::make_unique<double[]>(size);
    std::unique_ptr<double[]> signal_ratio = std::make_unique<double[]>(size);
    std::unique_ptr<double[]> molecule = std::make_unique<double[]>(size);
    std::ifstream mol_in;
    std::string filename;
    ...
    double lidar_ratio;
    std::unique_ptr<double[]> raman_backscatter = std::make_unique<double[]>(size);
    std::unique_ptr<double[]> fernald_backscatter = std::make_unique<double[]>(size);
